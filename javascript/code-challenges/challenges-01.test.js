...
const addOne = (arr) => {
  // Solution code here...
  let plusOne = [];
  arr.forEach((index) => plusOne.push(index + 1));
  return plusOne;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  let stringArr = [];
  arr.forEach((index) => stringArr.push(`${index}!`));
  return stringArr;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let upCaseArr = [];
  arr.forEach((index) => upCaseArr.push(index.toUpperCase()));
  return upCaseArr;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let newArr = [];
  words.forEach((index) => newArr.push(callback(index)));
  return newArr;
};
...
const createList = (availableItems) => {
  // Solution code here...
  let list = [];
  availableItems.forEach(index => { if (index.available) { list.push(index.name); } });
  return list;
};
