...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let thirdPowerArr=[];
  arr.forEach(index => thirdPowerArr.push(Math.pow(index,3))
  );
...
const addOne = (arr) => {
  // Solution code here...
  let incrementedArr=arr.map(index=> index+1);
...
const addQuestion = (arr) => {
  // Solution code here...
  let questionArr=arr.map(index=> `${index}?`);
  return questionArr;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    secondPowerArr.push(Math.pow(2,arr[i]));
  }
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let secondPowerArr=[];
  arr.forEach(index=>secondPowerArr.push(Math.pow(2,index)));
  return secondPowerArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let secondPowerArr=arr.map(index => Math.pow(2,index));
  return secondPowerArr;
};
