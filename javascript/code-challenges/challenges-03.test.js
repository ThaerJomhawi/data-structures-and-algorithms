...
const typeNum = (arr) => {
  ...
  let numOnlyArr = arr.filter(numOnly);
  return numOnlyArr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let andArr = arr.filter(index => index.includes('and'))
  return andArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddArr = arr.filter(index => index % 2);
  return oddArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let filteredArr = arr.filter(index => (!forbiddenValues.includes(index)))
  return filteredArr
};
/* ------------------------------------------------------------------------------------------------
